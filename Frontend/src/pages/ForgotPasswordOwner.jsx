...
function ForgotPasswordOwner() {
    ...
    async function handleReset(e) {
        ...
        const [err, res] = await to(
            request.post("/owner/forgotPassword", formData),
        );
    ...
    return (
        <div className="relative flex flex-col bg-white h-[500px] justify-center align-middle items-center">
            ...
            >
                <div className="mb-4">You will be able to reset your password using your registered email id or phone
                    number
                </div>
