...
function UpdatePasswordUser({id}) {
    ...
    async function handleReset(e) {
        ...
        const [err, res] = await to(request.patch("/user/updateMyPassword", formData),);
    ...
    return (<dialog id={id} className="modal text-left">
        <div className="modal-box w-full px-0">
            ...
            <div className="flex bg-white justify-center align-middle items-center">
                <form
                    onSubmit={handleReset}
                    className="py-8 flex w-[90%] flex-col gap-4 px-6 "
                >
                    <p>Enter the following fields to change your password. In case you forgot your current password,
                        logout and click on forgot password on login page.</p>
